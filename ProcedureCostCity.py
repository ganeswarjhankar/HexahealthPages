"""https://www.hexahealth.com/delhi/doctors/cardiologist"""
import time

import requests

"""Script for the City with Doctor as below  All the Automation points Covered"""
...
#####First Link#
CityDoctormethod_obj = CityDoctorClass()
CityDoctormethod_obj.CityDoctorBookmethod1()
######List Of doctors#
CityDoctoListMethod_obj = CityDoctorClass()
CityDoctoListMethod_obj.CityDoctorListMethod2()
######Object for the Main Form#
CityDoctorFormMethod_obj = CityDoctorClass()
CityDoctorFormMethod_obj.CityDoctorFormMethod3()

##To verify the WhatApp functionality
CityDoctorWhatApp_obj=CityDoctorClass()
CityDoctorWhatApp_obj.ContactUsWhatsapp()
